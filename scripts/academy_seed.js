// Academy Seed Data Script
// Creates sample data for the Foundations course
// Usage: node scripts/academy_seed.js
...
async function main() {
	console.log('🌱 Starting Academy seed data creation...');
	...
	const instructor = await pb.collections.create('users', {
		...
		role: 'instructor',
		handle: 'instructor',
		displayName: 'Academy Instructor',
		bio: 'Lead instructor for Academy coding courses',
		xp: 0,
		streakCount: 0
	});
